...
start()->
    ok=setup(),
    {ok,SortedStartedNodes}=start_cluster_1("c1",3,["c100"],"c1_cookie"),
    case SortedStartedNodes of
	[]->
	    io:format("DBG: error ~p~n",[{"eexist",SortedStartedNodes,?MODULE,?FUNCTION_NAME,?LINE}]);
	SortedStartedNodes->
		ok
	end,
